...
macro(add_convenience_library TARGET)
  set(SOURCES ${ARGV})
  list(REMOVE_AT SOURCES 0)
  add_library(${TARGET} STATIC ${SOURCES})
  set_target_properties(${TARGET} PROPERTIES COMPILE_FLAGS "${CMAKE_SHARED_LIBRARY_C_FLAGS}")
endmacro()
...
EXECUTE_PROCESS(COMMAND ${CMAKE_AR} -x ${lib} WORKING_DIRECTORY ${objdir})
# save the list of object files
EXECUTE_PROCESS(COMMAND ls . OUTPUT_FILE ${objlistfile} WORKING_DIRECTORY ${objdir})")
#---------------------------------
